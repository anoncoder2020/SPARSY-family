...
flags = tf.app.flags
FLAGS = flags.FLAGS
flags.DEFINE_string('load_metis_data_train', 'citeseer_4cluster.npy', 'load clusters.')
flags.DEFINE_integer('num_cluster', 4, 'number of clusters.')
flags.DEFINE_integer('batch_size', 3,'batch number of clusters.')
flags.DEFINE_float('percent_trained_node', 0.036,'for top_k_degree')
flags.DEFINE_float('top_k_degree', 0.01,'for top_k_degree')
flags.DEFINE_float('percent_edges', 0.01,'for percent edges')
...
print("num_cluster in train: ", FLAGS.num_cluster)
print("top_k_degree", FLAGS.top_k_degree)
...
for epoch in range(FLAGS.epochs):
    whole_dict, chosen_id = minbatch(labels, y, test_idx_range, FLAGS.batch_size, FLAGS.num_cluster, epoch, cluster_for_train,
                                      whole_adj, features_init, FLAGS.top_k_degree, FLAGS.percent_edges, FLAGS.percent_trained_node)
