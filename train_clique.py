...
flags.DEFINE_float('percent_edges', 1.0,'for percent edges')#1
flags.DEFINE_float('percent_trained_node', 0.005,'for top_k_degree')
...
flags.DEFINE_integer('early_stopping', 2500, 'Tolerance for early stopping (# of epochs).')
...
print("-----------------------------------------------")
print("load_metis_data_train", FLAGS.load_metis_data_train)
...
for epoch in range(FLAGS.epochs):
    whole_dict, chosen_id = minbatch_clique(labels, y, test_idx_range, FLAGS.batch_size, FLAGS.num_cluster, epoch, cluster_for_train,
                                      whole_adj, features_init, FLAGS.percent_edges,  FLAGS.percent_trained_node, size_clique=3)
